...
```{r}
# use the ROD as a qualifier for Criterion B assessments - the logic is that rapid ongoing rates of habitat loss  are sufficient evidence of "ongoing decline" for range restricted ecosystems types. 
