...
RLE_adjustments <- data.frame(
  T_MAPCODE = c("FFh5", "FOa1", "FS4", "Gh14", "Gm16", "Gm22", "Gs12", "SKv11"),
  RLE_adjusted = c( "CR", "VU", "CR", "EN", "EN", "EN", "EN", "EN"),
  Criteria_triggered_adjusted = c("B1i_rod, B2i_rod, B1iii_sp, B2iii_sp",
                                  "B2i_rod", "B1iii_sp", "B1i_rod", "B1i_rod",                                        "B1i_rod", "B1i_rod","D1_elk"),
...
New Incomplete - make plots - code from rivers repo
