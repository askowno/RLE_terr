...
RLE_full_compiled <- RLE_A2bA3_compiled %>%
 ...
 mutate(across(
  ...
  # RESULTS FOR AT49 need consideration : new status is EN old was VU (71 vs 69% degr - caused by habitat loss of nondegraded areas reducing natural extent and pushing up % degr). Could justify EN and uplist... 
  ...
  # RESULTS FOR FS4 need adjustment up to CR to match 2022 (right on TSp/km2 threshold) 
  ...
  # RESULTS FOR SKV11 need adjustment to EN to match 2022 Supplementary assessment which still holds true.
