...
# Expert Adjustments of Compiled RLE list 
  ...
  # RESULTS FOR SKV11 need adjustment up to EN to match 2022 Supplementary              assessment (Vlok et al 2020) which still holds true.
  
  # RESULTS FOR three Richertsveld types adjusted based on Jurgens et al 2025; this     data includes 50 years of longterm field plots.  
    # SKr7  mean 2.58 12 plots [EN] - drivers
    # SKr2  mean 6.21 15 plots [CR] - drivers
    # SKr13 mean 7.25 6 plots [CR] - drivers
